plots = {"Indices":["povertyRate","birthRate", "literacyRate", "infantMortality", "sexRatio2013", "lifeExpectancy2010to14"],
     	 ...
     	 "Cities":["populationOfCities", "airTrafficCities", "rainfallCities", "moterVehiclesOwnership", "wealthOfCities", "lengthOfMetro", "gdpOfCities", "growthOfWealth","siesmicZones", "billionares"],
         ...
         "Safety": ["crimeRate", "murderCrimeRate", "crimeAgainstWomenRate", "roadAccidentMortality"],
         "Tourism":["domesticTouristArrival", "foreignTouristArrival", "foreignTouristCityArrivals", "unescoHeritageSites"],
...
"domesticTouristArrival":{
			title: "Domestic Tourist Count",
			shortTitle: "Domestic Tourist Count",
			desc: "The map shows the domestic tourist visit counts for top ten states.",
			unit: "crore",
			processFunction: "crore",
...
"foreignTouristArrival":{
			title: "Foreign Tourist Count",
			shortTitle: "Foreign Tourist Count",
			desc: "The map shows the foreign tourist visit counts for top ten states.",
			unit: "lakh",
